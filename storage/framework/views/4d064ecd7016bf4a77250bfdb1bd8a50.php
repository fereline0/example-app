<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            <?php echo e(__('После удаления данного аккаунта все его ресурсы и данные будут безвозвратно удалены.')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['x-data' => '','x-on:click.prevent' => '$dispatch(\'open-modal\', \'confirm-user-deletion\')']); ?><?php echo e(__('Удалить
                                                аккаунт')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(route('users.destroy', $user->id)); ?>" class="p-6">
            <?php echo csrf_field(); ?>
            <?php echo method_field('delete'); ?>

            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                <?php echo e(__('Вы уверены, что хотите удалить данный аккаунт?')); ?>

            </h2>

            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                <?php echo e(__('Обратите внимание, что удаление аккаунта является необратимым процессом. Все данные, включая личную информацию и настройки, будут безвозвратно потеряны. Пожалуйста, убедитесь, что решение о продолжении удаления принято осознанно.')); ?>
...
<?php /**PATH /home/fereline/example-app/resources/views/users/partials/delete-user-form.blade.php ENDPATH**/ ?>