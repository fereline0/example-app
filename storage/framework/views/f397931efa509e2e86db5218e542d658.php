...
<?php $component->withAttributes([]); ?>
                    <div class="space-y-2">
                        <div class="flex flex-col sm:flex-row justify-between gap-2">
                            <div>
                                <h3 class="text-lg dark:text-white font-semibold"><?php echo e($vacancy->title); ?></h3>
                                <?php if($vacancy->salary): ?>
                                    <h3 class="text-lg dark:text-white font-semibold">
                                        <?php echo e(number_format($vacancy->salary)); ?> ₽
                                        в месяц</h3>
                                <?php endif; ?>
                                <?php if(count($vacancy->skills) > 0): ?>
                                    <?php if(auth()->guard()->check()): ?>
                                        <p class="text-lg dark:text-white font-semibold">
                                            Подходит вам на <?php echo e(number_format($percentage)); ?>% согласно вашим навыкам в
                                            резюме
                                        </p>
                                    <?php endif; ?>
                                <?php endif; ?>
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <div class="flex gap-2">
                                    <?php if(!$vacancy->users()->where('user_id', Auth::user()->id)->exists()): ?>
                                        <form action="<?php echo e(route('vacancies.applys.store', $vacancy->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit']); ?>Откликнуться <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    ...
                                    <?php else: ?>
                                        <form action="<?php echo e(route('vacancies.applys.destroy', $vacancy->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit']); ?>Отменить <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit', $vacancy->user)): ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Действия <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald411d1792bd6cc877d687758b753742c)): ?>
<?php $attributes = $__attributesOriginald411d1792bd6cc877d687758b753742c; ?>
<?php unset($__attributesOriginald411d1792bd6cc877d687758b753742c); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('vacancies.applys.show', $vacancy->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('vacancies.applys.show', $vacancy->id))]); ?>
...
<?php endif; ?>
                                                <?php if (isset($component)) { $__componentOriginal68cb1971a2b92c9735f83359058f7108 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal68cb1971a2b92c9735f83359058f7108 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('vacancies.edit', $vacancy->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dropdown-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('vacancies.edit', $vacancy->id))]); ?>
...
<?php endif; ?>
                                                <?php if (isset($component)) { $__componentOriginal68cb1971a2b92c9735f83359058f7108 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal68cb1971a2b92c9735f83359058f7108 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['xOn:click.prevent' => '$dispatch(\'open-modal\', \'confirm-vacancy-deletion\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dropdown-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-on:click.prevent' => '$dispatch(\'open-modal\', \'confirm-vacancy-deletion\')']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'confirm-vacancy-deletion','focusable' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'confirm-vacancy-deletion','focusable' => true]); ?>
                                        <form method="post" action="<?php echo e(route('vacancies.destroy', $vacancy->id)); ?>"
                                            ...
                                            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                                                <?php echo e(__('Вы уверены, что хотите удалить эту вакансию?')); ?>

                                            </h2>

                                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                                <?php echo e(__('После удаления вакансии все её ресурсы и данные будут
...
<?php $component->withAttributes(['class' => 'ms-3']); ?>
                                                    <?php echo e(__('Удалить вакансию')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'font-medium','href' => ''.e(route('users.show', $vacancy->user->id)).'']); ?><?php echo e($vacancy->user->name); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            ...
                            <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                                ...
                                <p class="dark:text-gray-200 font-medium"><?php echo e($vacancy->city->name); ?></p>
                            </div>

                            <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                                <p class="text-gray-500 dark:text-gray-300">Тип работы</p>
                                <p class="dark:text-gray-200 font-medium"><?php echo e($vacancy->workType->name); ?></p>
                            </div>

                            <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                                <p class="text-gray-500 dark:text-gray-300">Расписание работы</p>
                                <p class="dark:text-gray-200 font-medium"><?php echo e($vacancy->workSchedule->name); ?></p>
                            </div>

                            <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                                <p class="text-gray-500 dark:text-gray-300">Опыт работы</p>
                                <p class="dark:text-gray-200 font-medium"><?php echo e($vacancy->experience->name); ?></p>
                            </div>

                            <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                                <p class="text-gray-500 dark:text-gray-300">Образование</p>
                                <p class="dark:text-gray-200 font-medium"><?php echo e($vacancy->background->name); ?></p>
                            </div>

                            <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                                <p class="text-gray-500 dark:text-gray-300">Обновлено</p>
                                <p class="dark:text-gray-200 font-medium">
                                    <?php echo e($vacancy->updated_at->locale('ru')->diffForHumans()); ?></p>
                            </div>
                        </div>

                        <?php if(count($vacancy->skills) > 0): ?>
                            <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                                <p class="text-gray-500 dark:text-gray-300"><?php echo e(__('Навыки')); ?></p>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <p class="dark:text-white"><?php echo e($vacancy->description); ?></p>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal53747ceb358d30c0105769f8471417f6)): ?>
<?php $attributes = $__attributesOriginal53747ceb358d30c0105769f8471417f6; ?>
...
<?php endif; ?>
<?php /**PATH /home/fereline/example-app/resources/views/vacancies/show.blade.php ENDPATH**/ ?>